...
material_type_option = st.selectbox("Material type:",("Select","Metallic","Composite","Polymer","Ceramic","Other"))
...
load_type_dropdown = st.selectbox("Load Type:", ("Select","Force (kN)", "Pressure (MPa)", 
...
trial_input = st.number_input("Trial #:",value= None, placeholder= "Enter trial number..")
